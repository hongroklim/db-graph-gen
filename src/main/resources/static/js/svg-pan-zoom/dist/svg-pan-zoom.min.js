...
!function t(e, n, o) {
    ...
    3: [function(t, e, n) {
        ...
        s.prototype.init = function(t, e) {
                ...
                if (e || n) {
                    if (e && (this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a)) === !1 ? (t.a = t.d = this.activeState.zoom, e = !1) : (this.updateCache(t), this.options.onZoom(this.getRelativeZoom()))), n) {
                        var o = this.options.beforePan(this.getPan(), {
                            ...
                            s = !1,
                            r = !1;
                        o === !1 ? (t.e = this.getPan().x, t.f = this.getPan().y, s = r = !0) : i.isObject(o) && (o.x === !1 ? (t.e = this.getPan().x, s = !0) : i.isNumber(o.x) && (t.e = o.x), o.y === !1 ? (t.f = this.getPan().y, r = !0) : i.isNumber(o.y) && (t.f = o.y)),
                            s && r || !this.isPanDifferent(t) ? n = !1 : (this.updateCache(t), this.options.onPan(this.getPan()))
                    }
            ...
            s.prototype.updateCTM = function() {
                var t = this.getCTM();
                o.setCTM(this.viewport, t, this.defs),
    ...
    4: [function(t, e, n) {
        ...
        l.prototype.init = function(t, e) {
            ...
            this.width = o.width,
                ...
                this.viewport = a(r.getOrCreateViewport(this.svg, this.options.viewportSelector), {
                    ...
                    beforeZoom: function(t, e) {
                        return n.viewport && n.options.beforeZoom ? n.options.beforeZoom(t, e) : void 0
                    },
                    onZoom: function(t) {
                        return n.viewport && n.options.onZoom ? n.options.onZoom(t) : void 0
                    },
                    beforePan: function(t, e) {
                        return n.viewport && n.options.beforePan ? n.options.beforePan(t, e) : void 0
                    },
                    onPan: function(t) {
                        return n.viewport && n.options.onPan ? n.options.onPan(t) : void 0
                    },
                    onUpdatedCTM: function(t) {
                        return n.viewport && n.options.onUpdatedCTM ? n.options.onUpdatedCTM(t) : void 0
                    }
                });
            ...
            l.prototype.enableMouseWheelZoom = function() {
                if (!this.options.mouseWheelZoomEnabled) {
                    ...
                    this.wheelListener = function(e) {
                        ...
                        o.on(this.options.eventsListenerElement || this.svg, this.wheelListener, !1),
            ...
            l.prototype.handleMouseWheel = function(t) {
                if (this.options.zoomEnabled && "none" === this.state) {
                    ...
                    "deltaMode" in t && 0 === t.deltaMode && t.wheelDelta && (e = 0 === t.deltaY ? 0 : Math.abs(t.wheelDelta) / t.deltaY),
                        e = e > -.3 && .3 > e ? e : (e > 0 ? 1 : -1) * Math.log(Math.abs(e) + 10) / o;
            ...
            l.prototype.publicZoomAtPoint = function(t, e, n) {
            ...
            l.prototype.handleMouseDown = function(t, e) {
                this.options.preventMouseEventsDefault && (t.preventDefault ? t.preventDefault() : t.returnValue = !1),
                    ...
                    this.options.dblClickZoomEnabled && s.isDblClick(t, e) ? this.handleDblClick(t) : (this.state = "pan", this.firstEventCTM = this.viewport.getCTM(), this.stateOrigin = r.getEventPoint(t, this.svg).matrixTransform(this.firstEventCTM.inverse()))
            },
        ...
        var h = [],
            c = function(t, e) {
                ...
                for (var o = h.length - 1; o >= 0; o--)
                    if (h[o].svg === n)
                        return h[o].instance.getPublicInstance();
                return h.push({
                    svg: n,
                    instance: new l(n, e)
        ...
        document.documentMode && (i = "ie"),
            e.exports = {
                    ...
                    if (!n) {
                        ...
                        if (r && r.length > 0)
                            for (var a = r.length; a > 0; a--)
                                "defs" !== r[r.length - a].nodeName && n.appendChild(r[r.length - a]);
                        t.appendChild(n)
                    }
                    var l = [];
                ...
                setCTM: function(t, e, n) {
                    ...
                    "ie" === i && n && (n.parentNode.insertBefore(n, n), window.setTimeout(function() {
                        o.refreshDefsGlobal()
        ...
        e.exports = function() {
            function t(t, e, n) {
                var o = function(t) {
                    ...
                    return "mousewheel" == u ? (n.deltaY = -1 / 40 * t.wheelDelta, t.wheelDeltaX && (n.deltaX = -1 / 40 * t.wheelDeltaX)) : n.deltaY = t.detail, e(n)
                };
                return c.push({
                    element: t,
                    fn: o,
            ...
            function e(t, e) {
                for (var n = 0; n < c.length; n++)
                    if (c[n].element === t && c[n].capture === e)
                        return c[n].fn;
                return function() {}
            }
            function n(t, e) {
            ...
            function s(t, e, n) {
                o(t, u, e, n),
                "DOMMouseScroll" == u && o(t, "MozMousePixelScroll", e, n)
            }
            function r(t, e, n) {
                i(t, u, e, n),
                "DOMMouseScroll" == u && i(t, "MozMousePixelScroll", e, n)
            }
            var a,
                l,
                u,
    ...
    7: [function(t, e, n) {
        ...
        e.exports = {
            extend: function(t, e) {
                t = t || {};
                for (var n in e)
                    this.isObject(e[n]) ? t[n] = this.extend(t[n], e[n]) : t[n] = e[n];
                return t
            },
            ...
            getSvg: function(t) {
                ...
                if ("svg" === e.tagName.toLowerCase())
                    ...
                    n = e.contentDocument.documentElement;
                else {
                ...
                if (void 0 === t.clientX || null === t.clientX)
                    if (t.clientX = 0, t.clientY = 0, void 0 !== t.changedTouches && t.changedTouches.length) {
                        if (void 0 !== t.changedTouches[0].clientX)
                            ...
                            t.clientX = t.changedTouches[0].pageX - n.left,
                                t.clientY = t.changedTouches[0].pageY - n.top
                        }
                    } else
                        void 0 !== t.originalEvent && void 0 !== t.originalEvent.clientX && (t.clientX = t.originalEvent.clientX, t.clientY = t.originalEvent.clientY)
            },
