    ...
    ace.define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang"], function(e, t, n) {
        ...
        var r = e("../lib/event"),
            ...
            f = function(e, t) {
                ...
                var B = function(e) {
                        if (h || !t.onCompositionStart || t.$readOnly)
                            return;
                        h = {},
    ...
    ace.define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/config"], function(e, t, n) {
        ...
        var r = e("../lib/event"),
            ...
            l = function(e) {
                ...
                e.renderer.scrollBarV && (r.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [400, 300, 250], this, "onMouseEvent"), r.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [400, 300, 250], this, "onMouseEvent"), i.isIE && (r.addListener(e.renderer.scrollBarV.element, "mousedown", n), r.addListener(e.renderer.scrollBarH.element, "mousedown", n))),
            ...
            this.$setMaxTokenCount = function(e) {
                ...
                this.getLineTokens = function(e, t) {
                    ...
                    while (a = u.exec(e)) {
                        ...
                        if (v)
                            if (typeof p == "string")
                                !!d && d.merge === !1 || h.type !== p ? (h.type && f.push(h), h = {
                                    type: p,
                                    value: v
                                }) : h.value += v;
                            else if (p) {
            ...
            this.addRules = function(e, t) {
                ...
                for (var n in e) {
                    ...
                    for (var i = 0; i < r.length; i++) {
                        var s = r[i];
                        if (s.next || s.onMatch)
                            typeof s.next != "string" ? s.nextState && s.nextState.indexOf(t) !== 0 && (s.nextState = t + s.nextState) : s.next.indexOf(t) !== 0 && (s.next = t + s.next)
                    }
                    this.$rules[t + n] = r
                }
            },
            ...
            this.getFoldAt = function(e, t, n) {
                ...
                this.$toggleFoldWidget = function(e, t) {
                    ...
                    if (t.siblings) {
                        ...
                        t.children ? (f = o ? o.end.row : this.getLength(), this.foldAll(e + 1, f, t.all ? 1e4 : 0)) : o && (t.all && (o.collapseChildren = 1e4), this.addFold("...", o));
                    return o
                },
                    ...
                    f = this.getFoldLine(l, f),
                        f ? (a = [], f.walk(function(e, t, i, s) {
                            ...
                            if (e != null) {
                                ...
                                o = this.$getDisplayTokens(r[t].substring(s, i), a.length);
                            a = a.concat(o)
            ...
            r.implement(this, d),
                ...
                this.$updateHighlightActiveLine = function() {
                    ...
                    if (e.$highlightLineMarker && !t)
                        ...
                        t && (e.$highlightLineMarker.start.row = t.row, e.$highlightLineMarker.end.row = t.row, e.$highlightLineMarker.start.column = t.column, e._signal("changeBackMarker"))
                },
                ...
                this.$renderToken = function(e, t, n, r) {
                    var i = this,
                        ...
                        u = function(e, n, r, o, u) {
                            if (n)
                                return i.showInvisibles ? "<span class='ace_invisible ace_invisible_space'>" + s.stringRepeat(i.SPACE_CHAR, e.length) + "</span>" : e;
                            if (e == "&")
                                return "&#38;";
                            if (e == "<")
                                return "&#60;";
                        ...
                        if (!this.session.$fromUndo) {
                            if (e.action === "insert")
                                ...
                                for (var s = this.others.length - 1; s >= 0; s--) {
                                    ...
                                    o.row === t.start.row && t.start.column < o.column && (u.column += n),
                                        this.doc.remove(new r(u.row, u.column, u.row, u.column - n))
                                }
